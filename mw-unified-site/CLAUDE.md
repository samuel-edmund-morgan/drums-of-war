...
After every deployed change that affects the website UI or functionality, you MUST verify through Chrome MCP:
...
Do NOT skip this step. Do NOT ask the user to verify manually. Verify yourself.

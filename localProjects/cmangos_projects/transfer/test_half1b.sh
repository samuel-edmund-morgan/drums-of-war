...
echo "=== Set xp + money + totaltime + leveltime ==="
$D -e "UPDATE characters SET xp=31, money=37903267, totaltime=1202050, leveltime=146378 WHERE guid=1801" 2>/dev/null
echo "Set done"

echo "=== Verify ==="
$D -e "SELECT guid,name,at_login,playerFlags,xp,money,totaltime,leveltime,logout_time FROM characters WHERE guid=1801" 2>/dev/null

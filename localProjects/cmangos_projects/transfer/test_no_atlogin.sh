...
echo "=== Step 3: ALL numerics EXCEPT at_login (keep 0) ==="
$DOCKER "UPDATE characters SET xp=31,money=37903267,totaltime=1202050,leveltime=146378,logout_time=1772560692,rest_bonus=0,resettalents_cost=100000,resettalents_time=1752771490,watchedFaction=42,health=7234,power1=7348,power2=0,power4=100,actionBars=15,fishingSteps=2,cinematic=1,playerFlags=2080,playerBytes2=33947654 WHERE guid=1801" 2>/dev/null
echo "Numerics set (at_login stays 0)"

echo "=== Verify ==="
$DOCKER "SELECT guid,name,at_login,playerFlags,playerBytes2,health,money FROM characters WHERE guid=1801" 2>/dev/null

      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-[#9a9a9a] mb-10">
            Race, class, and level distribution across all realms
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {VALID_PATCHES.map((patch) => {
              ...
              return (
                <Link key={patch} href={`/stats/${patch}`}>
                  <div
                    className="bg-[#141418] border border-[#2a2a32] rounded-xl p-6 hover:bg-[#1a1a20] transition-colors cursor-pointer group"
